<x-app-layout>
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto ml-12">
            <h1 class="text-4xl font-bold leading-8 text-gray-900">Permissions</h1>
            <p class="mt-2 text-base text-gray-500">A list of all the users in your account including their name, title, email and permission.</p>
        </div>
    ...
    <div class="mt-8 flex justify-center">
        <div class="w-full max-w-6xl overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                <x-list :items="$permissions" :columns="['name']" edit-route="permission.edit" destroy-route="permission.destroy" />
            </div>
        </div>
    </div>
